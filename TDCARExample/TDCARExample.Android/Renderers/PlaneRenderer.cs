...
namespace TDCARExample.Droid.Renderers
{
	public class PlaneRenderer
	{
		...
		{
            ShaderUtil.CheckGLError(TAG, "Before anything");
            ...
            ShaderUtil.CheckGLError(TAG, "clearing the alpha channel");

            // Disable depth write.
            GLES20.GlDepthMask(false);
            ShaderUtil.CheckGLError(TAG, "Disable depth write");
            ...
            ShaderUtil.CheckGLError(TAG, "blending");

            // Set up the shader.
            GLES20.GlUseProgram(mPlaneProgram);
            ShaderUtil.CheckGLError(TAG, "shader");

            // Attach the texture.
            GLES20.GlActiveTexture(GLES20.GlTexture0);
            GLES20.GlBindTexture(GLES20.GlTexture2d, mTextures[0]);
            GLES20.GlUniform1i(mTextureUniform, 0);
            ShaderUtil.CheckGLError(TAG, "Attach the texture");

            // Shared fragment uniforms.
            //GLES20.GlUniform4fv(mGridControlUniform, 1, GRID_CONTROL, 0);
            ShaderUtil.CheckGLError(TAG, "Shared fragment uniforms");
